...
describe('youMagineDriver', () => {
  it('should handle data saving', function (done) {
    ...
    const saveData = {
      ...
      authData: {token: '42'} // bom & parts        bom: [{id: 0, qty: 2, phys_qty: 1}], // assemblies data         eMetas: {id: 1,typeUid: 0, name: 'one'},         eTrans: {id: 1,typeUid: 0, pos: [0, 0, 1], rot: [1, 1, 1], sca: [1, 1, 1]},         eMeshs: {id: 1,typeUid: 0}
    }
