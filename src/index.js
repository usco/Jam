...
function SettingsView({DOM, props$}, name = '') {
  ...
  let settings$ = props$.pluck('settings').startWith({showGrid:false})
...
function view({DOM,props$}){
  ...
  let settingsUi = SettingsView({DOM, props$:_props$}, "settingsView")
  let settingsUIDom$ = settingsUi.DOM

  return Rx.Observable.combineLatest(settingsUIDom$,function(settingsView){
